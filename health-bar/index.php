...
<body>
    <header>
        <div id="logo">
            <svg width="32px" height="32px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"> <path d=" M1 2 h25 l4 6 l-4 6 h-16 m16 0 l4 6 l-6 9 l-2 -3 h-17 v-18 h17"stroke="#fff"stroke-width="3"fill="none" /></svg>
            <h2>Rvo Works</h2>
        </div>
