...
$f = isset($_GET['f']) ? $_GET['f'] == 'c' || $_GET['f'] == 'yt' ? $_GET['f'] : 'error' : 'other';
$filename = "./visit/{$f}.txt";
...
window.addEventListener('scroll', () => {
    ...
    if (currentScrollY < lastScrollY) {
        if (currentScrollY > 0) header.classList.add('header-colored');
        else header.classList.remove('header-colored');

        header.classList.remove('header-hidden');
    } else {
        if (currentScrollY > 0) header.classList.add('header-hidden');
        else header.classList.remove('header-colored');
    }
